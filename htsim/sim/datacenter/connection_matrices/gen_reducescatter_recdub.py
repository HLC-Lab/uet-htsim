...
# python gen_reducescatter_recdub.py <nodes> <conns> <groupsize> <flowsize>
# Parameters:
...
if len(sys.argv) != 6:
    print("Usage: python gen_reducescatter_recdub.py <filename> <nodes> <conns> <flowsize> <randseed>")
    sys.exit()
filename = sys.argv[1]
